var baseUrl = '/leadflow/';
var worker = new Worker(baseUrl + 'assets/js/webWorkerEvents.js');
$('[data-menu]').removeClass('selected');
var menuSelected = location.pathname.split('/').pop();
if(menuSelected == '') {
  menuSelected = 'mensagens';
}
$('[data-menu="'+menuSelected+'"]').addClass('selected');
$(document).ready(function($){
  ...
  function triggerAnimation(newSection, bool) {
    isAnimating =  true;
    newSection = ( newSection == '' ) ? 'mensagens' : newSection;
