function ClientWebsocket() {
  ...
  this.STATE_CLOSED = 3;
  this.serverUrl = 'ws://192.168.1.8:3333';
...
ClientWebsocket.prototype.recursiveDecrypt = function (data) {
  if(typeof data != 'boolean') {
    if(typeof data == 'object') {
      $.each(data, function(key, value) {
        if(data[key] != null) {
          data[key] = websocket.recursiveDecrypt(data[key].toString());
...
ClientWebsocket.prototype.recursiveEncrypt = function (data) {
  if(typeof data != 'boolean') {
    if(typeof data == 'object') {
      $.each(data, function(key, value) {
        if(data[key] != null) {
          data[key] = websocket.recursiveEncrypt(data[key].toString());
        }
      });
    } else {
      if(data != null) {
